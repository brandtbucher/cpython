...
if __name__ == "__main__":
    ...
    print("XXX: jit_stencils_hack.h -> jit_stencils.h")
    hack = pathlib.Path(__file__).parent.parent.parent.joinpath("jit_stencils_hack.h")
    real = pathlib.Path(__file__).parent.parent.parent.joinpath("jit_stencils.h")
    shutil.copy(hack, real)
