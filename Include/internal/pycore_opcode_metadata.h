...
const struct opcode_metadata _PyOpcode_opcode_metadata[264] = {
    ...
    [ENTER_EXECUTOR] = { true, INSTR_FMT_IBC, HAS_ARG_FLAG | HAS_ESCAPES_FLAG },
    ...
    [OPTIMIZE] = { true, INSTR_FMT_IXC, HAS_ERROR_FLAG | HAS_ESCAPES_FLAG },
