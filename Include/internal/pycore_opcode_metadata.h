...
_PyOpcode_macro_expansion[256] = {
    ...
    [BINARY_OP_ADD_FLOAT] = { .nuops = 4, .uops = { { _GUARD_BOTH_FLOAT, 0, 0 }, { _UNBOX_BOTH_FLOAT, 0, 0 }, { _BINARY_OP_ADD_FLOAT, 0, 0 }, { _BOX_FLOAT, 0, 0 } } },
    ...
    [BINARY_OP_MULTIPLY_FLOAT] = { .nuops = 4, .uops = { { _GUARD_BOTH_FLOAT, 0, 0 }, { _UNBOX_BOTH_FLOAT, 0, 0 }, { _BINARY_OP_MULTIPLY_FLOAT, 0, 0 }, { _BOX_FLOAT, 0, 0 } } },
    [BINARY_OP_MULTIPLY_INT] = { .nuops = 2, .uops = { { _GUARD_BOTH_INT, 0, 0 }, { _BINARY_OP_MULTIPLY_INT, 0, 0 } } },
    [BINARY_OP_SUBTRACT_FLOAT] = { .nuops = 4, .uops = { { _GUARD_BOTH_FLOAT, 0, 0 }, { _UNBOX_BOTH_FLOAT, 0, 0 }, { _BINARY_OP_SUBTRACT_FLOAT, 0, 0 }, { _BOX_FLOAT, 0, 0 } } },
