...
_PyOpcode_macro_expansion[256] = {
    ...
    [BINARY_OP_ADD_INT] = { .nuops = 4, .uops = { { _GUARD_BOTH_INT, 0, 0 }, { _BINARY_OP_ADD_INT, 0, 0 }, { _POP_UNDER_INT, 0, 0 }, { _POP_UNDER_INT, 0, 0 } } },
    [BINARY_OP_ADD_UNICODE] = { .nuops = 4, .uops = { { _GUARD_BOTH_UNICODE, 0, 0 }, { _BINARY_OP_ADD_UNICODE, 0, 0 }, { _POP_UNDER_UNICODE, 0, 0 }, { _POP_UNDER_UNICODE, 0, 0 } } },
    ...
    [BINARY_OP_MULTIPLY_INT] = { .nuops = 4, .uops = { { _GUARD_BOTH_INT, 0, 0 }, { _BINARY_OP_MULTIPLY_INT, 0, 0 }, { _POP_UNDER_INT, 0, 0 }, { _POP_UNDER_INT, 0, 0 } } },
    [BINARY_OP_SUBTRACT_FLOAT] = { .nuops = 2, .uops = { { _GUARD_BOTH_FLOAT, 0, 0 }, { _BINARY_OP_SUBTRACT_FLOAT, 0, 0 } } },
    [BINARY_OP_SUBTRACT_INT] = { .nuops = 4, .uops = { { _GUARD_BOTH_INT, 0, 0 }, { _BINARY_OP_SUBTRACT_INT, 0, 0 }, { _POP_UNDER_INT, 0, 0 }, { _POP_UNDER_INT, 0, 0 } } },
    ...
    [TO_BOOL_ALWAYS_TRUE] = { .nuops = 3, .uops = { { _GUARD_TYPE_VERSION, 2, 1 }, { _POP_TOP, 0, 0 }, { _PUSH_TRUE, 0, 0 } } },
