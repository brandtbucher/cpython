...
#define _GUARD_REUSE_LHS 307
#define _GUARD_REUSE_RHS 308
#define _GUARD_REUSE_NEITHER 309
#define _BINARY_OP_MULTIPLY_FLOAT_LHS 310
#define _BINARY_OP_MULTIPLY_FLOAT_RHS 311
#define _BINARY_OP_MULTIPLY_FLOAT_NEW 312
#define _BINARY_OP_ADD_FLOAT_LHS 313
#define _BINARY_OP_ADD_FLOAT_RHS 314
#define _BINARY_OP_ADD_FLOAT_NEW 315
#define _BINARY_OP_SUBTRACT_FLOAT_LHS 316
#define _BINARY_OP_SUBTRACT_FLOAT_RHS 317
#define _BINARY_OP_SUBTRACT_FLOAT_NEW 318
#define _GUARD_BOTH_UNICODE 319
#define _BINARY_OP_ADD_UNICODE 320
#define _BINARY_OP_INPLACE_ADD_UNICODE 321
#define _POP_FRAME 322
#define _GUARD_GLOBALS_VERSION 323
#define _GUARD_BUILTINS_VERSION 324
#define _LOAD_GLOBAL_MODULE 325
#define _LOAD_GLOBAL_BUILTINS 326
#define _GUARD_TYPE_VERSION 327
#define _CHECK_MANAGED_OBJECT_HAS_VALUES 328
#define _LOAD_ATTR_INSTANCE_VALUE 329
#define _CHECK_ATTR_MODULE 330
#define _LOAD_ATTR_MODULE 331
#define _CHECK_ATTR_WITH_HINT 332
#define _LOAD_ATTR_WITH_HINT 333
#define _LOAD_ATTR_SLOT 334
#define _CHECK_ATTR_CLASS 335
#define _LOAD_ATTR_CLASS 336
#define _GUARD_DORV_VALUES 337
#define _STORE_ATTR_INSTANCE_VALUE 338
#define _STORE_ATTR_SLOT 339
#define _IS_NONE 340
#define _ITER_CHECK_LIST 341
#define _ITER_JUMP_LIST 342
#define _IS_ITER_EXHAUSTED_LIST 343
#define _ITER_NEXT_LIST 344
#define _ITER_CHECK_TUPLE 345
#define _ITER_JUMP_TUPLE 346
#define _IS_ITER_EXHAUSTED_TUPLE 347
#define _ITER_NEXT_TUPLE 348
#define _ITER_CHECK_RANGE 349
#define _ITER_JUMP_RANGE 350
#define _IS_ITER_EXHAUSTED_RANGE 351
#define _ITER_NEXT_RANGE 352
#define _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT 353
#define _GUARD_KEYS_VERSION 354
#define _LOAD_ATTR_METHOD_WITH_VALUES 355
#define _LOAD_ATTR_METHOD_NO_DICT 356
#define _LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES 357
#define _LOAD_ATTR_NONDESCRIPTOR_NO_DICT 358
#define _CHECK_ATTR_METHOD_LAZY_DICT 359
#define _LOAD_ATTR_METHOD_LAZY_DICT 360
...
int _PyOpcode_num_popped(int opcode, int oparg, bool jump)  {
    switch(opcode) {
        ...
        case _BINARY_OP_SUBTRACT_FLOAT_NEW:
            return 2;
        case BINARY_OP_MULTIPLY_FLOAT_LHS:
            return 2;
        case BINARY_OP_MULTIPLY_FLOAT_RHS:
            return 2;
        case BINARY_OP_MULTIPLY_FLOAT_NEW:
            return 2;
        case BINARY_OP_ADD_FLOAT_LHS:
            return 2;
        case BINARY_OP_ADD_FLOAT_RHS:
            return 2;
        case BINARY_OP_ADD_FLOAT_NEW:
            return 2;
        case BINARY_OP_SUBTRACT_FLOAT_LHS:
            return 2;
        case BINARY_OP_SUBTRACT_FLOAT_RHS:
            return 2;
        case BINARY_OP_SUBTRACT_FLOAT_NEW:
            return 2;
...
const struct opcode_metadata _PyOpcode_opcode_metadata[OPCODE_METADATA_SIZE] = {
    ...
    [_GUARD_REUSE_LHS] = { true, INSTR_FMT_IX, HAS_DEOPT_FLAG },
    [_GUARD_REUSE_RHS] = { true, INSTR_FMT_IX, HAS_DEOPT_FLAG },
    [_GUARD_REUSE_NEITHER] = { true, INSTR_FMT_IX, HAS_DEOPT_FLAG },
    [_BINARY_OP_MULTIPLY_FLOAT_LHS] = { true, INSTR_FMT_IXC, 0 },
    [_BINARY_OP_MULTIPLY_FLOAT_RHS] = { true, INSTR_FMT_IXC, 0 },
    [_BINARY_OP_MULTIPLY_FLOAT_NEW] = { true, INSTR_FMT_IXC, HAS_ERROR_FLAG },
    [_BINARY_OP_ADD_FLOAT_LHS] = { true, INSTR_FMT_IXC, 0 },
    [_BINARY_OP_ADD_FLOAT_RHS] = { true, INSTR_FMT_IXC, 0 },
    [_BINARY_OP_ADD_FLOAT_NEW] = { true, INSTR_FMT_IXC, HAS_ERROR_FLAG },
    [_BINARY_OP_SUBTRACT_FLOAT_LHS] = { true, INSTR_FMT_IXC, 0 },
    [_BINARY_OP_SUBTRACT_FLOAT_RHS] = { true, INSTR_FMT_IXC, 0 },
    [_BINARY_OP_SUBTRACT_FLOAT_NEW] = { true, INSTR_FMT_IXC, HAS_ERROR_FLAG },
    [BINARY_OP_MULTIPLY_FLOAT_LHS] = { true, INSTR_FMT_IXC, HAS_DEOPT_FLAG },
    [BINARY_OP_MULTIPLY_FLOAT_RHS] = { true, INSTR_FMT_IXC, HAS_DEOPT_FLAG },
    [BINARY_OP_MULTIPLY_FLOAT_NEW] = { true, INSTR_FMT_IXC, HAS_DEOPT_FLAG | HAS_ERROR_FLAG },
    [BINARY_OP_ADD_FLOAT_LHS] = { true, INSTR_FMT_IXC, HAS_DEOPT_FLAG },
    [BINARY_OP_ADD_FLOAT_RHS] = { true, INSTR_FMT_IXC, HAS_DEOPT_FLAG },
    [BINARY_OP_ADD_FLOAT_NEW] = { true, INSTR_FMT_IXC, HAS_DEOPT_FLAG | HAS_ERROR_FLAG },
    [BINARY_OP_SUBTRACT_FLOAT_LHS] = { true, INSTR_FMT_IXC, HAS_DEOPT_FLAG },
    [BINARY_OP_SUBTRACT_FLOAT_RHS] = { true, INSTR_FMT_IXC, HAS_DEOPT_FLAG },
    [BINARY_OP_SUBTRACT_FLOAT_NEW] = { true, INSTR_FMT_IXC, HAS_DEOPT_FLAG | HAS_ERROR_FLAG },
...
const struct opcode_macro_expansion _PyOpcode_macro_expansion[OPCODE_MACRO_EXPANSION_SIZE] = {
    ...
    [BINARY_OP_MULTIPLY_FLOAT_LHS] = { .nuops = 3, .uops = { { _GUARD_BOTH_FLOAT, 0, 0 }, { _GUARD_REUSE_LHS, 0, 0 }, { _BINARY_OP_MULTIPLY_FLOAT_LHS, 0, 0 } } },
    [BINARY_OP_MULTIPLY_FLOAT_RHS] = { .nuops = 3, .uops = { { _GUARD_BOTH_FLOAT, 0, 0 }, { _GUARD_REUSE_RHS, 0, 0 }, { _BINARY_OP_MULTIPLY_FLOAT_RHS, 0, 0 } } },
    [BINARY_OP_MULTIPLY_FLOAT_NEW] = { .nuops = 3, .uops = { { _GUARD_BOTH_FLOAT, 0, 0 }, { _GUARD_REUSE_NEITHER, 0, 0 }, { _BINARY_OP_MULTIPLY_FLOAT_NEW, 0, 0 } } },
    [BINARY_OP_ADD_FLOAT_LHS] = { .nuops = 3, .uops = { { _GUARD_BOTH_FLOAT, 0, 0 }, { _GUARD_REUSE_LHS, 0, 0 }, { _BINARY_OP_ADD_FLOAT_LHS, 0, 0 } } },
    [BINARY_OP_ADD_FLOAT_RHS] = { .nuops = 3, .uops = { { _GUARD_BOTH_FLOAT, 0, 0 }, { _GUARD_REUSE_RHS, 0, 0 }, { _BINARY_OP_ADD_FLOAT_RHS, 0, 0 } } },
    [BINARY_OP_ADD_FLOAT_NEW] = { .nuops = 3, .uops = { { _GUARD_BOTH_FLOAT, 0, 0 }, { _GUARD_REUSE_NEITHER, 0, 0 }, { _BINARY_OP_ADD_FLOAT_NEW, 0, 0 } } },
    [BINARY_OP_SUBTRACT_FLOAT_LHS] = { .nuops = 3, .uops = { { _GUARD_BOTH_FLOAT, 0, 0 }, { _GUARD_REUSE_LHS, 0, 0 }, { _BINARY_OP_SUBTRACT_FLOAT_LHS, 0, 0 } } },
    [BINARY_OP_SUBTRACT_FLOAT_RHS] = { .nuops = 3, .uops = { { _GUARD_BOTH_FLOAT, 0, 0 }, { _GUARD_REUSE_RHS, 0, 0 }, { _BINARY_OP_SUBTRACT_FLOAT_RHS, 0, 0 } } },
    [BINARY_OP_SUBTRACT_FLOAT_NEW] = { .nuops = 3, .uops = { { _GUARD_BOTH_FLOAT, 0, 0 }, { _GUARD_REUSE_NEITHER, 0, 0 }, { _BINARY_OP_SUBTRACT_FLOAT_NEW, 0, 0 } } },
...
const char * const _PyOpcode_uop_name[OPCODE_UOP_NAME_SIZE] = {
    ...
    [_GUARD_REUSE_LHS] = "_GUARD_REUSE_LHS",
    [_GUARD_REUSE_RHS] = "_GUARD_REUSE_RHS",
    [_GUARD_REUSE_NEITHER] = "_GUARD_REUSE_NEITHER",
    [_BINARY_OP_MULTIPLY_FLOAT_LHS] = "_BINARY_OP_MULTIPLY_FLOAT_LHS",
    [_BINARY_OP_MULTIPLY_FLOAT_RHS] = "_BINARY_OP_MULTIPLY_FLOAT_RHS",
    [_BINARY_OP_MULTIPLY_FLOAT_NEW] = "_BINARY_OP_MULTIPLY_FLOAT_NEW",
    [_BINARY_OP_ADD_FLOAT_LHS] = "_BINARY_OP_ADD_FLOAT_LHS",
    [_BINARY_OP_ADD_FLOAT_RHS] = "_BINARY_OP_ADD_FLOAT_RHS",
    [_BINARY_OP_ADD_FLOAT_NEW] = "_BINARY_OP_ADD_FLOAT_NEW",
    [_BINARY_OP_SUBTRACT_FLOAT_LHS] = "_BINARY_OP_SUBTRACT_FLOAT_LHS",
    [_BINARY_OP_SUBTRACT_FLOAT_RHS] = "_BINARY_OP_SUBTRACT_FLOAT_RHS",
    [_BINARY_OP_SUBTRACT_FLOAT_NEW] = "_BINARY_OP_SUBTRACT_FLOAT_NEW",
...
const char *const _PyOpcode_OpName[268] = {
    ...
    [BINARY_OP_ADD_FLOAT_LHS] = "BINARY_OP_ADD_FLOAT_LHS",
    [BINARY_OP_ADD_FLOAT_NEW] = "BINARY_OP_ADD_FLOAT_NEW",
    [BINARY_OP_ADD_FLOAT_RHS] = "BINARY_OP_ADD_FLOAT_RHS",
    [BINARY_OP_ADD_INT] = "BINARY_OP_ADD_INT",
    [BINARY_OP_ADD_UNICODE] = "BINARY_OP_ADD_UNICODE",
    [BINARY_OP_MULTIPLY_FLOAT_LHS] = "BINARY_OP_MULTIPLY_FLOAT_LHS",
    [BINARY_OP_MULTIPLY_FLOAT_NEW] = "BINARY_OP_MULTIPLY_FLOAT_NEW",
    [BINARY_OP_MULTIPLY_FLOAT_RHS] = "BINARY_OP_MULTIPLY_FLOAT_RHS",
    [BINARY_OP_MULTIPLY_INT] = "BINARY_OP_MULTIPLY_INT",
    [BINARY_OP_SUBTRACT_FLOAT_LHS] = "BINARY_OP_SUBTRACT_FLOAT_LHS",
    [BINARY_OP_SUBTRACT_FLOAT_NEW] = "BINARY_OP_SUBTRACT_FLOAT_NEW",
    [BINARY_OP_SUBTRACT_FLOAT_RHS] = "BINARY_OP_SUBTRACT_FLOAT_RHS",
...
const uint8_t _PyOpcode_Deopt[256] = {
    ...
    [BEFORE_WITH] = BEFORE_WITH,
    [BINARY_OP] = BINARY_OP,
    [BINARY_OP_ADD_FLOAT_LHS] = BINARY_OP,
    [BINARY_OP_ADD_FLOAT_NEW] = BINARY_OP,
    [BINARY_OP_ADD_FLOAT_RHS] = BINARY_OP,
    [BINARY_OP_ADD_INT] = BINARY_OP,
    [BINARY_OP_ADD_UNICODE] = BINARY_OP,
    [BINARY_OP_INPLACE_ADD_UNICODE] = BINARY_OP,
    [BINARY_OP_MULTIPLY_FLOAT_LHS] = BINARY_OP,
    [BINARY_OP_MULTIPLY_FLOAT_NEW] = BINARY_OP,
    [BINARY_OP_MULTIPLY_FLOAT_RHS] = BINARY_OP,
    [BINARY_OP_MULTIPLY_INT] = BINARY_OP,
    [BINARY_OP_SUBTRACT_FLOAT_LHS] = BINARY_OP,
    [BINARY_OP_SUBTRACT_FLOAT_NEW] = BINARY_OP,
    [BINARY_OP_SUBTRACT_FLOAT_RHS] = BINARY_OP,
