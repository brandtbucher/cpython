...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_ITER_CHECK_DICT_ITEMS_SPLIT] = HAS_EXIT_FLAG,
    [_ITER_CHECK_DICT_ITEMS_UNICODE] = HAS_EXIT_FLAG,
    [_ITER_CHECK_DICT_ITEMS_GENERAL] = HAS_EXIT_FLAG,
    [_GUARD_NOT_EXHAUSTED_DICT_ITEMS_SPLIT] = HAS_EXIT_FLAG,
    [_GUARD_NOT_EXHAUSTED_DICT_ITEMS_UNICODE] = HAS_EXIT_FLAG,
    [_GUARD_NOT_EXHAUSTED_DICT_ITEMS_GENERAL] = HAS_EXIT_FLAG,
    [_ITER_NEXT_DICT_ITEMS_SPLIT] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_ITER_NEXT_DICT_ITEMS_UNICODE] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_ITER_NEXT_DICT_ITEMS_GENERAL] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_GUARD_NOT_EXHAUSTED_DICT_ITEMS_GENERAL] = "_GUARD_NOT_EXHAUSTED_DICT_ITEMS_GENERAL",
    [_GUARD_NOT_EXHAUSTED_DICT_ITEMS_SPLIT] = "_GUARD_NOT_EXHAUSTED_DICT_ITEMS_SPLIT",
    [_GUARD_NOT_EXHAUSTED_DICT_ITEMS_UNICODE] = "_GUARD_NOT_EXHAUSTED_DICT_ITEMS_UNICODE",
    ...
    [_ITER_CHECK_DICT_ITEMS_GENERAL] = "_ITER_CHECK_DICT_ITEMS_GENERAL",
    [_ITER_CHECK_DICT_ITEMS_SPLIT] = "_ITER_CHECK_DICT_ITEMS_SPLIT",
    [_ITER_CHECK_DICT_ITEMS_UNICODE] = "_ITER_CHECK_DICT_ITEMS_UNICODE",
    [_ITER_CHECK_LIST] = "_ITER_CHECK_LIST",
    [_ITER_CHECK_RANGE] = "_ITER_CHECK_RANGE",
    [_ITER_CHECK_TUPLE] = "_ITER_CHECK_TUPLE",
    [_ITER_NEXT_DICT_ITEMS_GENERAL] = "_ITER_NEXT_DICT_ITEMS_GENERAL",
    [_ITER_NEXT_DICT_ITEMS_SPLIT] = "_ITER_NEXT_DICT_ITEMS_SPLIT",
    [_ITER_NEXT_DICT_ITEMS_UNICODE] = "_ITER_NEXT_DICT_ITEMS_UNICODE",
