...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_RESUME_CHECK] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    ...
    [_RETURN_VALUE] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_GUARD_IS_TRUE_POP] = 0,
    [_GUARD_IS_FALSE_POP] = 0,
    [_GUARD_IS_NONE_POP] = HAS_ESCAPES_FLAG,
    [_GUARD_IS_NOT_NONE_POP] = HAS_ESCAPES_FLAG,
    [_JUMP] = 0,
    [_SET_IP] = 0,
