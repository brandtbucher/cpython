...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_CALL_ALLOC_AND_ENTER_INIT_FRAME] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_CALL_ALLOC_AND_ENTER_INIT_FRAME] = "_CALL_ALLOC_AND_ENTER_INIT_FRAME",
