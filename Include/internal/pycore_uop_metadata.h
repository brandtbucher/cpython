...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_CHECK_FOR_ITER_GEN] = HAS_EXIT_FLAG,
    [_CHECK_FOR_ITER_GEN_FUNCTION] = HAS_EXIT_FLAG,
    [_CHECK_FOR_ITER_GEN_OFFSET] = HAS_EXIT_FLAG,
    [_FOR_ITER_GEN_FRAME] = HAS_ARG_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_CHECK_FOR_ITER_GEN] = "_CHECK_FOR_ITER_GEN",
    [_CHECK_FOR_ITER_GEN_FUNCTION] = "_CHECK_FOR_ITER_GEN_FUNCTION",
    [_CHECK_FOR_ITER_GEN_OFFSET] = "_CHECK_FOR_ITER_GEN_OFFSET",
    ...
    [_CHECK_SEND_GEN] = "_CHECK_SEND_GEN",
    [_CHECK_SEND_GEN_FUNCTION] = "_CHECK_SEND_GEN_FUNCTION",
    [_CHECK_SEND_GEN_OFFSET] = "_CHECK_SEND_GEN_OFFSET",
