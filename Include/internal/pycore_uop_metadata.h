...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_MULTIPLY_INT] = HAS_DEOPT_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_ADD_INT] = HAS_DEOPT_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_SUBTRACT_INT] = HAS_DEOPT_FLAG | HAS_PURE_FLAG,
    ...
    [_ITER_NEXT_RANGE] = HAS_DEOPT_FLAG,
