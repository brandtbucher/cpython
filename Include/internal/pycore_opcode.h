...
const uint8_t _PyOpcode_Deopt[256] = {
    ...
    [LOAD_CONST_IMMORTAL__LOAD_FAST] = LOAD_CONST_IMMORTAL,
    [LOAD_DEREF] = LOAD_DEREF,
    [LOAD_FAST] = LOAD_FAST,
    [LOAD_FAST_AND_CLEAR] = LOAD_FAST_AND_CLEAR,
    [LOAD_FAST_CHECK] = LOAD_FAST_CHECK,
    [LOAD_FAST__LOAD_CONST_IMMORTAL] = LOAD_FAST,
...
static const char *const _PyOpcode_OpName[267] = {
    ...
    [RETURN_VALUE] = "RETURN_VALUE",
    [LOAD_CONST_IMMORTAL__LOAD_FAST] = "LOAD_CONST_IMMORTAL__LOAD_FAST",
    [SETUP_ANNOTATIONS] = "SETUP_ANNOTATIONS",
    [LOAD_FAST__LOAD_CONST_IMMORTAL] = "LOAD_FAST__LOAD_CONST_IMMORTAL",
    [LOAD_LOCALS] = "LOAD_LOCALS",
