...
const uint8_t _PyOpcode_Deopt[256] = {
    ...
    [BINARY_SUBSCR_QUICK] = BINARY_SUBSCR,
    ...
    [COMPARE_OP_ADAPTIVE_PRE] = COMPARE_OP,
    [COMPARE_OP_FLOAT] = COMPARE_OP,
    [COMPARE_OP_INT] = COMPARE_OP,
    [COMPARE_OP_QUICK] = COMPARE_OP,
    ...
    [LOAD_CONST_ADAPTIVE] = LOAD_CONST,
    [LOAD_CONST_QUICK] = LOAD_CONST,
    [LOAD_CONST__LOAD_FAST] = LOAD_CONST,
    [LOAD_DEREF] = LOAD_DEREF,
    [LOAD_FAST] = LOAD_FAST,
    [LOAD_FAST_ADAPTIVE] = LOAD_FAST,
    [LOAD_FAST_CHECK] = LOAD_FAST_CHECK,
    [LOAD_FAST_QUICK] = LOAD_FAST,
    ...
    [STORE_ATTR_QUICK] = STORE_ATTR,
    [STORE_ATTR_SLOT] = STORE_ATTR,
    [STORE_ATTR_WITH_HINT] = STORE_ATTR,
    [STORE_DEREF] = STORE_DEREF,
    [STORE_FAST] = STORE_FAST,
    [STORE_FAST_ADAPTIVE] = STORE_FAST,
    [STORE_FAST_QUICK] = STORE_FAST,
    ...
    [STORE_SUBSCR_QUICK] = STORE_SUBSCR,
    [SWAP] = SWAP,
    ...
    [UNPACK_SEQUENCE_QUICK] = UNPACK_SEQUENCE,
...
static const char *const _PyOpcode_OpName[263] = {
    ...
    [UNARY_INVERT] = "UNARY_INVERT",
    [BINARY_OP_QUICK] = "BINARY_OP_QUICK",
    ...
    [BINARY_SUBSCR_QUICK] = "BINARY_SUBSCR_QUICK",
    ...
    [JUMP_IF_FALSE_OR_POP] = "JUMP_IF_FALSE_OR_POP",
    [JUMP_IF_TRUE_OR_POP] = "JUMP_IF_TRUE_OR_POP",
    [LOAD_ATTR_QUICK] = "LOAD_ATTR_QUICK",
    [POP_JUMP_IF_FALSE] = "POP_JUMP_IF_FALSE",
    [POP_JUMP_IF_TRUE] = "POP_JUMP_IF_TRUE",
    [LOAD_GLOBAL] = "LOAD_GLOBAL",
    [IS_OP] = "IS_OP",
    ...
    [LOAD_CONST_ADAPTIVE] = "LOAD_CONST_ADAPTIVE",
    [LOAD_CONST_QUICK] = "LOAD_CONST_QUICK",
    ...
    [LOAD_FAST_ADAPTIVE] = "LOAD_FAST_ADAPTIVE",
    [LOAD_FAST_QUICK] = "LOAD_FAST_QUICK",
    ...
    [LOAD_GLOBAL_QUICK] = "LOAD_GLOBAL_QUICK",
    [STORE_ATTR_ADAPTIVE] = "STORE_ATTR_ADAPTIVE",
    [STORE_ATTR_INSTANCE_VALUE] = "STORE_ATTR_INSTANCE_VALUE",
    [STORE_ATTR_QUICK] = "STORE_ATTR_QUICK",
    [STORE_ATTR_SLOT] = "STORE_ATTR_SLOT",
    [STORE_ATTR_WITH_HINT] = "STORE_ATTR_WITH_HINT",
    [STORE_FAST__LOAD_FAST] = "STORE_FAST__LOAD_FAST",
    [STORE_FAST__STORE_FAST] = "STORE_FAST__STORE_FAST",
    [STORE_FAST_ADAPTIVE] = "STORE_FAST_ADAPTIVE",
    [STORE_FAST_QUICK] = "STORE_FAST_QUICK",
    [STORE_SUBSCR_ADAPTIVE] = "STORE_SUBSCR_ADAPTIVE",
    [STORE_SUBSCR_DICT] = "STORE_SUBSCR_DICT",
    [STORE_SUBSCR_LIST_INT] = "STORE_SUBSCR_LIST_INT",
    [STORE_SUBSCR_QUICK] = "STORE_SUBSCR_QUICK",
    [UNPACK_SEQUENCE_ADAPTIVE] = "UNPACK_SEQUENCE_ADAPTIVE",
    [UNPACK_SEQUENCE_LIST] = "UNPACK_SEQUENCE_LIST",
    [UNPACK_SEQUENCE_QUICK] = "UNPACK_SEQUENCE_QUICK",
