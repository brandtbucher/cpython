...
{
    _PyOpcode_BinOp oparg;
    switch (binop) {
        case Add:
            // Interaction with sq_concat breaks BINARY_OP.
        ...
        case Sub:
            ...
            break;
        case Mult:
            // Multiplication interacts with sq_repeat, which breaks BINARY_OP.
        ...
        case Mod:
            ...
            break;
        case Pow:
            // nb_power is technically ternary, which breaks BINARY_OP.
