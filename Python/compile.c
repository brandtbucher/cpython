...
struct assembler {
    ...
    basicblock *a_entry;
    int a_offset;              /* offset into compressed bytecode */
...
assemble_emit(struct assembler *a, struct instr *i)
{
    ...
    unsigned char *code = (unsigned char *)PyBytes_AS_STRING(a->a_bytecode) + a->a_offset;
    a->a_offset += size;
