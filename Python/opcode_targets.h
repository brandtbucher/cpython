static void *opcode_targets[256] = {
    ...
    &&_unknown_opcode,
    &&TARGET_RESUME,
    &&TARGET_BINARY_OP_ADD_FLOAT_LHS,
    &&TARGET_BINARY_OP_ADD_FLOAT_NEW,
    &&TARGET_BINARY_OP_ADD_FLOAT_RHS,
    &&TARGET_BINARY_OP_ADD_INT,
    &&TARGET_BINARY_OP_ADD_UNICODE,
    &&TARGET_BINARY_OP_MULTIPLY_FLOAT_LHS,
    &&TARGET_BINARY_OP_MULTIPLY_FLOAT_NEW,
    &&TARGET_BINARY_OP_MULTIPLY_FLOAT_RHS,
    &&TARGET_BINARY_OP_MULTIPLY_INT,
    &&TARGET_BINARY_OP_SUBTRACT_FLOAT_LHS,
    &&TARGET_BINARY_OP_SUBTRACT_FLOAT_NEW,
    &&TARGET_BINARY_OP_SUBTRACT_FLOAT_RHS,
