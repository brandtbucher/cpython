...
Py_PRESERVE_NONE_CC static PyObject *_TAIL_CALL_YIELD_VALUE_KNOWN(TAIL_CALL_PARAMS);
...
static py_tail_call_funcptr INSTRUCTION_TABLE[256] = {
    ...
    [YIELD_VALUE_KNOWN] = _TAIL_CALL_YIELD_VALUE_KNOWN,
