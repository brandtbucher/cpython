static void *opcode_targets[256] = {
    ...
    &&TARGET_BINARY_SUBSCR_LIST_SLICE_NONE_NONE,
    &&TARGET_GET_LEN,
    &&TARGET_MATCH_MAPPING,
    &&TARGET_MATCH_SEQUENCE,
    &&TARGET_MATCH_KEYS,
    &&TARGET_BINARY_SUBSCR_LIST_SLICE_INT_NONE,
    &&TARGET_PUSH_EXC_INFO,
    &&TARGET_BINARY_SUBSCR_LIST_SLICE_NONE_INT,
    &&TARGET_BINARY_SUBSCR_LIST_SLICE_INT_INT,
    &&TARGET_BINARY_SUBSCR_TUPLE_INT,
    &&TARGET_BINARY_SUBSCR_DICT,
    &&TARGET_STORE_SUBSCR_ADAPTIVE,
    &&TARGET_STORE_SUBSCR_LIST_INT,
    &&TARGET_STORE_SUBSCR_LIST_SLICE_NONE_NONE,
    &&TARGET_STORE_SUBSCR_LIST_SLICE_INT_NONE,
    &&TARGET_STORE_SUBSCR_LIST_SLICE_NONE_INT,
    &&TARGET_STORE_SUBSCR_LIST_SLICE_INT_INT,
