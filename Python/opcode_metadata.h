...
const struct opcode_metadata _PyOpcode_opcode_metadata[256] = {
    ...
    [LOAD_FAST] = { true, INSTR_FMT_IX },
    [LOAD_FAST_QUICK] = { true, INSTR_FMT_IB },
    [LOAD_CONST] = { true, INSTR_FMT_IX },
    [LOAD_CONST_QUICK] = { true, INSTR_FMT_IB },
    [STORE_FAST] = { true, INSTR_FMT_IX },
    [STORE_FAST_QUICK] = { true, INSTR_FMT_IB },
