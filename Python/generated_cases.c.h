...
// Do not edit!
        ...
        TARGET(LOAD_FAST) {
            ...
            #line 61 "Python/generated_cases.c.h"
        }

        TARGET(LOAD_FAST_QUICK) {
            PREDICTED(LOAD_FAST_QUICK);
            PyObject *value;
            #line 125 "Python/bytecodes.c"
            value = GETLOCAL(oparg);
            assert(value != NULL);
            Py_INCREF(value);
            #line 71 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(LOAD_CONST_QUICK) {
            ...
            Py_INCREF(value);
            #line 98 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(STORE_FAST_QUICK) {
            PREDICTED(STORE_FAST_QUICK);
        ...
        TARGET(LOAD_FAST__LOAD_FAST) {
            ...
            oparg = (next_instr++)->op.arg;
            {
                ...
                assert(value != NULL);
                Py_INCREF(value);
                #line 151 "Python/generated_cases.c.h"
                _tmp_1 = value;
            }
            STACK_GROW(2);
        ...
        TARGET(LOAD_FAST__LOAD_CONST) {
            PREDICTED(LOAD_FAST__LOAD_CONST);
            PyObject *_tmp_1;
            PyObject *_tmp_2;
            {
                PyObject *value;
                ...
                assert(value != NULL);
                Py_INCREF(value);
                #line 170 "Python/generated_cases.c.h"
                _tmp_2 = value;
            }
            oparg = (next_instr++)->op.arg;
            {
        ...
        TARGET(STORE_FAST__LOAD_FAST) {
            PREDICTED(STORE_FAST__LOAD_FAST);
        ...
        TARGET(STORE_FAST__STORE_FAST) {
            PREDICTED(STORE_FAST__STORE_FAST);
            PyObject *_tmp_1 = stack_pointer[-1];
            ...
            oparg = (next_instr++)->op.arg;
            {
                ...
                #line 163 "Python/bytecodes.c"
                SETLOCAL(oparg, value);
                #line 226 "Python/generated_cases.c.h"
            }
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(LOAD_CONST__LOAD_FAST) {
            PREDICTED(LOAD_CONST__LOAD_FAST);
            PyObject *_tmp_1;
            PyObject *_tmp_2;
            {
                PyObject *value;
        ...
        TARGET(BINARY_OP_MULTIPLY_INT) {
            ...
            #line 360 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
        ...
        TARGET(LIST_APPEND) {
            ...
            #line 715 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
        ...
        TARGET(DELETE_SUBSCR) {
            ...
            #line 829 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(GET_AWAITABLE) {
            ...
            #line 1073 "Python/generated_cases.c.h"
            stack_pointer[-1] = iter;
            PREDICT(LOAD_CONST);
            DISPATCH();
        }
        ...
        TARGET(POP_EXCEPT) {
            ...
            #line 1182 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(BUILD_STRING) {
            ...
            #line 1865 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
            stack_pointer[-1] = str;
            DISPATCH();
        ...
        TARGET(BUILD_SET) {
            ...
            #line 1956 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
            stack_pointer[-1] = set;
            DISPATCH();
