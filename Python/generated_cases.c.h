...
#define TIER_ONE 1
        ...
        TARGET(BINARY_OP_ADD_FLOAT) {
            ...
            static_assert(INLINE_CACHE_ENTRIES_BINARY_OP == 0, "incorrect cache size");
            PyObject *right;
            PyObject *left;
            PyObject *res;
            // _GUARD_BOTH_FLOAT
        ...
        TARGET(BINARY_SUBSCR_DICT) {
            ...
            static_assert(INLINE_CACHE_ENTRIES_BINARY_SUBSCR == 0, "incorrect cache size");
            PyObject *sub;
            PyObject *dict;
            PyObject *res;
            sub = stack_pointer[-1];
        ...
        TARGET(CALL_ALLOC_AND_ENTER_INIT) {
            ...
            static_assert(INLINE_CACHE_ENTRIES_CALL == 2, "incorrect cache size");
            PyObject **args;
            PyObject *null;
            PyObject *callable;
            /* Skip 2 cache entries */
        ...
        TARGET(CALL_BOUND_METHOD_EXACT_ARGS) {
            ...
            callable = func;
            {
                uint32_t func_version = read_u32(&this_instr[1].cache);
