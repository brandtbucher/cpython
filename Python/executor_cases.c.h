...
#define TIER_TWO 2
        ...
        case _GUARD_GLOBALS_VERSION: {
            uint16_t version = (uint16_t)CURRENT_OPERAND_0();
        ...
        case _LOAD_GLOBAL_MODULE_FROM_KEYS: {
            ...
            uint16_t index = (uint16_t)CURRENT_OPERAND_0();
        ...
        case _GUARD_TYPE_VERSION: {
            _PyStackRef owner;
            owner = stack_pointer[-1];
            uint32_t type_version = (uint32_t)CURRENT_OPERAND_0();
        ...
        case _LOAD_ATTR_INSTANCE_VALUE_0: {
            ...
            (void)null;
            owner = stack_pointer[-1];
            uint16_t offset = (uint16_t)CURRENT_OPERAND_0();
            PyObject *owner_o = PyStackRef_AsPyObjectBorrow(owner);
        ...
        case _CHECK_ATTR_MODULE: {
            _PyStackRef owner;
            owner = stack_pointer[-1];
            uint32_t dict_version = (uint32_t)CURRENT_OPERAND_0();
            PyObject *owner_o = PyStackRef_AsPyObjectBorrow(owner);
        ...
        case _LOAD_ATTR_WITH_HINT: {
            ...
            oparg = CURRENT_OPARG();
            owner = stack_pointer[-1];
            uint16_t hint = (uint16_t)CURRENT_OPERAND_0();
            PyObject *owner_o = PyStackRef_AsPyObjectBorrow(owner);
            PyObject *attr_o;
            PyDictObject *dict = _PyObject_GetManagedDict(owner_o);
        ...
        case _LOAD_ATTR_CLASS_0: {
            ...
            (void)null;
            owner = stack_pointer[-1];
            PyObject *descr = (PyObject *)CURRENT_OPERAND_0();
            STAT_INC(LOAD_ATTR, hit);
            assert(descr != NULL);
        ...
        case _LOAD_ATTR_PROPERTY_FRAME: {
            ...
            oparg = CURRENT_OPARG();
            owner = stack_pointer[-1];
            PyObject *fget = (PyObject *)CURRENT_OPERAND_0();
            assert((oparg & 1) == 0);
        ...
        case _GUARD_KEYS_VERSION: {
            _PyStackRef owner;
            owner = stack_pointer[-1];
            uint32_t keys_version = (uint32_t)CURRENT_OPERAND_0();
        ...
        case _CHECK_ATTR_METHOD_LAZY_DICT: {
            _PyStackRef owner;
            owner = stack_pointer[-1];
            uint16_t dictoffset = (uint16_t)CURRENT_OPERAND_0();
        ...
        case _CHECK_FUNCTION_VERSION: {
            ...
            oparg = CURRENT_OPARG();
            callable = &stack_pointer[-2 - oparg];
            uint32_t func_version = (uint32_t)CURRENT_OPERAND_0();
            PyObject *callable_o = PyStackRef_AsPyObjectBorrow(callable[0]);
        ...
        case _SET_IP: {
            PyObject *instr_ptr = (PyObject *)CURRENT_OPERAND_0();
            frame->instr_ptr = (_Py_CODEUNIT *)instr_ptr;
            break;
        }

        case _CHECK_STACK_SPACE_OPERAND: {
            uint32_t framesize = (uint32_t)CURRENT_OPERAND_0();
        ...
        case _EXIT_TRACE: {
            PyObject *exit_p = (PyObject *)CURRENT_OPERAND_0();
        ...
        case _LOAD_CONST_INLINE: {
            _PyStackRef value;
            PyObject *ptr = (PyObject *)CURRENT_OPERAND_0();
        ...
        case _START_EXECUTOR: {
            PyObject *executor = (PyObject *)CURRENT_OPERAND_0();
        ...
        case _ERROR_POP_N: {
            oparg = CURRENT_OPARG();
            uint32_t target = (uint32_t)CURRENT_OPERAND_0();
