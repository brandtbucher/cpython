...
_PyUOp_Replacements[MAX_UOP_ID + 1] = {
    [_ITER_JUMP_DICT_ITEMS_SPLIT] = _GUARD_NOT_EXHAUSTED_DICT_ITEMS_SPLIT,
    [_ITER_JUMP_DICT_ITEMS_UNICODE] = _GUARD_NOT_EXHAUSTED_DICT_ITEMS_UNICODE,
    [_ITER_JUMP_DICT_ITEMS_GENERAL] = _GUARD_NOT_EXHAUSTED_DICT_ITEMS_GENERAL,
...
is_for_iter_test[MAX_UOP_ID + 1] = {
    [_GUARD_NOT_EXHAUSTED_DICT_ITEMS_SPLIT] = 1,
    [_GUARD_NOT_EXHAUSTED_DICT_ITEMS_UNICODE] = 1,
    [_GUARD_NOT_EXHAUSTED_DICT_ITEMS_GENERAL] = 1,
