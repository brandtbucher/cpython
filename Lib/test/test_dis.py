...
expected_opinfo_jumpy = [
  ...
  Instruction(opname='JUMP_FORWARD', opcode=110, arg=38, argval=214, argrepr='to 214', offset=136, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='CALL_NO_KW', opcode=169, arg=0, argval=0, argrepr='', offset=150, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='STORE_FAST', opcode=125, arg=1, argval='dodgy', argrepr='dodgy', offset=152, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='LOAD_GLOBAL', opcode=116, arg=1, argval='print', argrepr='print', offset=154, starts_line=26, is_jump_target=False, positions=None),
  Instruction(opname='LOAD_CONST', opcode=100, arg=9, argval='Never reach this', argrepr="'Never reach this'", offset=156, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='CALL_NO_KW', opcode=169, arg=1, argval=1, argrepr='', offset=158, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='LOAD_CONST', opcode=100, arg=0, argval=None, argrepr='None', offset=162, starts_line=25, is_jump_target=False, positions=None),
  ...
  Instruction(opname='DUP_TOP', opcode=4, arg=None, argval=None, argrepr='', offset=166, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='CALL_NO_KW', opcode=169, arg=3, argval=3, argrepr='', offset=168, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='JUMP_FORWARD', opcode=110, arg=14, argval=202, argrepr='to 202', offset=172, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='PUSH_EXC_INFO', opcode=35, arg=None, argval=None, argrepr='', offset=174, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='COPY', opcode=120, arg=4, argval=4, argrepr='', offset=176, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='COPY', opcode=120, arg=2, argval=2, argrepr='', offset=178, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='WITH_EXCEPT_START', opcode=49, arg=None, argval=None, argrepr='', offset=180, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='CALL_NO_KW', opcode=169, arg=3, argval=3, argrepr='', offset=182, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='POP_JUMP_IF_TRUE', opcode=115, arg=97, argval=194, argrepr='to 194', offset=184, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='RERAISE', opcode=119, arg=2, argval=2, argrepr='', offset=186, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='POP_TOP', opcode=1, arg=None, argval=None, argrepr='', offset=194, starts_line=None, is_jump_target=True, positions=None),
  ...
  Instruction(opname='LOAD_GLOBAL', opcode=116, arg=1, argval='print', argrepr='print', offset=202, starts_line=28, is_jump_target=True, positions=None),
  Instruction(opname='LOAD_CONST', opcode=100, arg=10, argval="OK, now we're done", argrepr='"OK, now we\'re done"', offset=204, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='CALL_NO_KW', opcode=169, arg=1, argval=1, argrepr='', offset=206, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='RETURN_VALUE', opcode=83, arg=None, argval=None, argrepr='', offset=212, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='NOP', opcode=9, arg=None, argval=None, argrepr='', offset=214, starts_line=23, is_jump_target=True, positions=None),
  Instruction(opname='LOAD_GLOBAL', opcode=116, arg=1, argval='print', argrepr='print', offset=216, starts_line=28, is_jump_target=False, positions=None),
  Instruction(opname='LOAD_CONST', opcode=100, arg=10, argval="OK, now we're done", argrepr='"OK, now we\'re done"', offset=218, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='CALL_NO_KW', opcode=169, arg=1, argval=1, argrepr='', offset=220, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='LOAD_CONST', opcode=100, arg=0, argval=None, argrepr='None', offset=224, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='RETURN_VALUE', opcode=83, arg=None, argval=None, argrepr='', offset=226, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='PUSH_EXC_INFO', opcode=35, arg=None, argval=None, argrepr='', offset=228, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='CALL_NO_KW', opcode=169, arg=1, argval=1, argrepr='', offset=234, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='RERAISE', opcode=119, arg=0, argval=0, argrepr='', offset=238, starts_line=None, is_jump_target=False, positions=None),
