...
expected_opinfo_jumpy = [
  ...
  Instruction(opname='POP_JUMP_IF_FALSE', opcode=114, arg=102, argval=204, argrepr='to 204', offset=186, starts_line=None, is_jump_target=False, positions=None),
