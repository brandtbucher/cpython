...
expected_opinfo_jumpy = [
  ...
  Instruction(opname='BINARY_OP', opcode=120, arg=17, argval=17, argrepr='-=', offset=68, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='BINARY_OP', opcode=120, arg=8, argval=8, argrepr='/', offset=110, starts_line=None, is_jump_target=False, positions=None),
