...
expected_opinfo_jumpy = [
  ...
  Instruction(opname='FOR_ITER', opcode=93, arg=16, argval=44, argrepr='to 44', offset=10, starts_line=None, is_jump_target=True, positions=None),
  ...
  Instruction(opname='POP_JUMP_IF_FALSE', opcode=114, arg=5, argval=10, argrepr='to 10', offset=38, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='JUMP_FORWARD', opcode=110, arg=4, argval=52, argrepr='to 52', offset=42, starts_line=None, is_jump_target=False, positions=None),
