...
expected_opinfo_jumpy = [
  ...
  Instruction(opname='JUMP_FORWARD', opcode=110, arg=39, argval=216, argrepr='to 216', offset=136, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='JUMP_FORWARD', opcode=110, arg=15, argval=204, argrepr='to 204', offset=172, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='COPY', opcode=120, arg=5, argval=5, argrepr='', offset=178, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='ROT_TWO', opcode=2, arg=None, argval=None, argrepr='', offset=180, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='WITH_EXCEPT_START', opcode=49, arg=None, argval=None, argrepr='', offset=182, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='CALL_NO_KW', opcode=169, arg=3, argval=3, argrepr='', offset=184, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='POP_JUMP_IF_TRUE', opcode=115, arg=98, argval=196, argrepr='to 196', offset=186, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='RERAISE', opcode=119, arg=2, argval=2, argrepr='', offset=188, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='COPY', opcode=120, arg=3, argval=3, argrepr='', offset=190, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='POP_EXCEPT', opcode=89, arg=None, argval=None, argrepr='', offset=192, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='RERAISE', opcode=119, arg=1, argval=1, argrepr='', offset=194, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='POP_TOP', opcode=1, arg=None, argval=None, argrepr='', offset=196, starts_line=None, is_jump_target=True, positions=None),
  ...
  Instruction(opname='LOAD_GLOBAL', opcode=116, arg=1, argval='print', argrepr='print', offset=204, starts_line=28, is_jump_target=True, positions=None),
  ...
  Instruction(opname='CALL_NO_KW', opcode=169, arg=1, argval=1, argrepr='', offset=208, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='NOP', opcode=9, arg=None, argval=None, argrepr='', offset=216, starts_line=23, is_jump_target=True, positions=None),
  ...
  Instruction(opname='CALL_NO_KW', opcode=169, arg=1, argval=1, argrepr='', offset=222, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='CALL_NO_KW', opcode=169, arg=1, argval=1, argrepr='', offset=236, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='COPY', opcode=120, arg=3, argval=3, argrepr='', offset=242, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='POP_EXCEPT', opcode=89, arg=None, argval=None, argrepr='', offset=244, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='RERAISE', opcode=119, arg=1, argval=1, argrepr='', offset=246, starts_line=None, is_jump_target=False, positions=None),
]
